...
// TODO
// когда € кликаю - буква уже добавилась у игрока. - но она visible(false)
// когда фейкова€ буква до туда долетает - мы просто еЄ удал€ем и делаем visible(true). 
...
void GameLayer::gameOver(){
	...
	// Ќа котором будет Score финальный, кнопки newGame и Main Menu
}
